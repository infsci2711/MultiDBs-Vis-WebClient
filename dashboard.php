            ...
            <div class="navbar-inner">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="#" onclick="gridView(2,3)">2 * 3</a></li>
                        ...
                        <button  class="btn topBarr" name="viewQuery" id="viewQuery" onclick="showQuery()">View Query</button>
                        <script type="text/javascript">
                          var searchQuery = window.opener.document.getElementById("search").value;
                          function showQuery(){
                          var myWindow = window.open("", "", "width=200, height=200"); 
                          //var searchQuery = "abcd";
                          myWindow.document.write("<title>Search Query</title>");
                          myWindow.document.write("<h4>Search Query:</h4>");
                          myWindow.document.write(searchQuery);
                          myWindow.blur(); 
                        }
                        </script>
